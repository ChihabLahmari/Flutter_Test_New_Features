...
class TreeSliverExample2 extends StatefulWidget {
  const TreeSliverExample2({super.key});

  @override
  State<TreeSliverExample2> createState() => _TreeSliverExample2State();
}

class _TreeSliverExample2State extends State<TreeSliverExample2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedNode != null) {
      selectedChildren.addAll(<Widget>[
        const Spacer(),
        Icon(
          _selectedNode!.children.isEmpty ? Icons.file_open_outlined : Icons.folder_outlined,
        ),
